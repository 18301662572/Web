...
func request_Order_PostOrder_0(ctx context.Context, marshaler runtime.Marshaler, client OrderClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_Order_PostOrder_0(ctx context.Context, marshaler runtime.Marshaler, server OrderServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq OrderReq
	var metadata runtime.ServerMetadata
...
func RegisterOrderHandlerServer(ctx context.Context, mux *runtime.ServeMux, server OrderServer) error {
	...
	mux.Handle("POST", pattern_Order_PostOrder_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_Order_PostOrder_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_Order_PostOrder_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterOrderHandlerClient(ctx context.Context, mux *runtime.ServeMux, client OrderClient) error {
	...
	mux.Handle("POST", pattern_Order_PostOrder_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Order_PostOrder_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_Order_PostOrder_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"postorder"}, "", runtime.AssumeColonVerbOpt(true)))
)

var (
	forward_Order_PostOrder_0 = runtime.ForwardResponseMessage
)
